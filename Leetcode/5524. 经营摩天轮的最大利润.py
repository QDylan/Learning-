# -*- coding: utf-8 -*-
"""
 @Time    : 2020-09-27 14:14
 @Author  : QDY
 @FileName: 5524. 经营摩天轮的最大利润.py
 @Software: PyCharm
"""
"""
你正在经营一座摩天轮，该摩天轮共有 4 个座舱 ，每个座舱 最多可以容纳 4 位游客 。你可以 逆时针轮转座舱，
...
你可以随时停下摩天轮，即便是 在服务所有游客之前 。如果你决定停止运营摩天轮，
为了保证所有游客安全着陆，将免费进行所有后续轮转。
...
class Solution:
    def minOperationsMaxProfit(self, customers, boardingCost: int, runningCost: int) -> int:
        ...
        for i, c in enumerate(customers):
            ...
            cur += new
            rest -= new
            nxt_profit = cur * boardingCost - runningCost * num
            if nxt_profit > profit:
                profit = nxt_profit
                res = num
            num += 1
        while rest:
